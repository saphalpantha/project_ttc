...
const BoardMember = () => {
  return (
        ...
        <div className="flex flex-col justify-between space-y-10 ">
          <h1 className=" text-white bg-[#FF9900] font-semibold text-3xl text-center ">
            BOARD MEMBERS
          </h1>
