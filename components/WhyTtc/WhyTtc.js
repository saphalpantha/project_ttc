  ...
  return (
    ...
    <h1 className=' text-3xl md:text-5xl  text-[#FF9900] font-bold text-center md:text-start'>Why Tilottama?</h1>
            <ul className='flex flex-col gap-3 list-disc'>
              {whyTTCList.map(i => (<li className='max-w-md w-fit px-3 text-start  md:w-[90%] lg:w-[100%] md:max-w-[30rem] lg:max-w-[60rem] px-[0.5rem]  md:px-0 leading-7 text-xl'>{i.desc}</li>))}
            </ul>
            </div>
