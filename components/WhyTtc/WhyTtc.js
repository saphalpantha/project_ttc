...
const WhyTtc = () => {
  return (
    <div className='max-w-6xl md:max-w-full bg-white flex justify-around p-2 pr-2 pb-[2rem]'>
            <div className='flex flex-col justify-center space-y-5'><h1 className='text-5xl text-[#FF9900] font-bold'>Why Tilottama?</h1>
            <p className='max-w-[60rem] leading-7 text-2xs'>Ut ex reprehenderit Lorem aliquip eiusmod id anim sint mollit occaecat dolor non irure aliqua. Labore irure veniam veniam commodo pariatur aliqua dolor duis quis. Ipsum nisi occaecat ullamco deserunt commodo minim laborum culpa culpa proident ex laborum pariatur. Enim culpa fugiat ex exercitation. Do reprehenderit sit sunt enim eu exercitation aliqua eu amet qui sunt. Minim ea aliqua labore tempor occaecat est et aliquip laborum id fugiat commodo do.
