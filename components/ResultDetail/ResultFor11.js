        ...
        <div className="max-w-6xl mx-auto px-0 flex flex-col justify-between space-y-5 py-[3rem]">
          <div className="pb-[1rem]">
            ...
            <form className="flex flex-col justify-center items-center">
                ...
                <select className="w-[20rem] h-[3.5rem] border-2 border-[#201F54] text-black px-[1rem] rounded-full" value="Science">
                ...
                <div className="flex flex-col space-y-3">
                    ...
                    <input type="date" className="w-[20rem] h-[3.5rem] border-2 border-[#201F54] px-[1rem] text-black rounded-full"></input>
                </div>
                <div className="flex flex-col space-y-3">
                    <label className="text-xl text-center text-[#201F54]">Registration No</label>
                    <input type="number" className="w-[20rem] h-[3.5rem] border-2 border-[#201F54] text-xl text-black px-[1rem] rounded-full"></input>
                </div>
                </div>
