        ...
        <div className="mx-auto px-0 flex flex-col justify-between space-y-5 py-[3rem] items-center justify-center items-center ">
          <div className="pb-[1rem]">
            ...
            <form className="flex flex-col justify-center items-center gap-10">
                ...
                <div className="py-3  bg-[#201F54] rounded-full hover:bg-[#FF9900] transition-all duration-200 cursor-pointer ease-in  text-center  px-8 text-white text-xl font-semibold">Check Results</div>
            </form>
          </div>
        </div>
      </section>
