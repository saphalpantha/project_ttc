...
const StreamDetailLayout = () => {
  return (
    <Fragment>
      ...
      <section className="flex flex-col pb-[5rem]">
        <div className="max-w-6xl md:max-w-full bg-white flex justify-around  pb-[5rem] pt-[5rem] justify-center items-center">
          <div className="flex flex-col justify-center space-y-5">
            <h1 className="text-5xl text-[#FF9900] font-bold">
              Department of Science
            </h1>
            <p className="max-w-[40rem] leading-9 text-2xs pb-[0.2rem]">
            ...
            <p className="max-w-[40rem] leading-9 text-2xs">
        ...
        <div className="flex flex-col justify-center space-y-5 pl-[5rem]">
          <h1 className="text-5xl text-[#FF9900] font-bold">
