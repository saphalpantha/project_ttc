    ...
    <Container>
      ...
      <section className="max-w-6xl md:max-w-full pb-[5rem] px-[4ren] md:px-0">
        <div className="mx-auto max-w-6xl space-y-[5rem]">
          ...
          <Link href={`/${streamData.link}`}><div className=" transition-all duration-300 ease hover:bg-[#201F54] hover:text-white  text-center mx-auto font-semibold text-[#201F54] text-2xl w-[100%] border-4 border-[#201F54] py-2 ">
