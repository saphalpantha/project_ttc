...
const Login = () => {
  ...
  return (
    <div
      className={`${classes.login} min-h-screen gap-10  w-[100vw]  flex flex-col  justify-center items-center relative z-10`}
    >
      <div className="absolute flex flex-col gap-10 justify-center items-center">
        ...
        <div className="max-w-[30rem] w-[100%] gap-10 py-3  bg-white height-[30rem] flex flex-col justify-center items-center rounded-3xl border-4 border-[#FF9900]">
          ...
          <form
            className="flex flex-col gap-5  h-[20rem] w-[30rem]  items-center"
          ...
          >
            <div className="flex gap-2 flex-col justify-center">
              ...
              <input
                ...
                type="text"
                className="w-[20rem] pl-[1rem] h-[2.7rem] border-2 rounded-xl border-[#201F54]"
              ></input>
            </div>
            <div className="flex gap-2 flex-col justify-center">
            ...
            <button className="bg-[#201F54] hover:bg-[#FF9900] transition-all duration-150 w-[40%] text-center  text-white font-bold uppercase py-3 px-10 rounded-full">
              Login
            </button>
          </form>
        </div>
