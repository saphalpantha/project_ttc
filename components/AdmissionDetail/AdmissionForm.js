...
const AdmissionForm = () => {
  return (
    <Fragment>
      ...
      <div className="grid justify-center place-items-center px-[15rem]  gap-5  grid-cols-1 mx-auto  md:grid-cols-6 gap-2 md:gap-y-3  md:grid-row-2">
      ...
      <div className="grid justify-center place-items-center px-[15rem]  gap-5  grid-cols-1 mx-auto  md:grid-cols-2 gap-2 md:gap-y-3  md:grid-row-2">
      ...
      <div className="grid justify-center w-[55%] gap-5   grid-cols-1 mx-auto  md:grid-cols-4 gap-2 md:gap-y-5 ">
      <div className="flex  space-x-4 text-center">
                  ...
                  <input
                    className=" w-[45%]  h-[3rem] border-2 border-[#000] px-[1rem] text-black rounded-3xl"
                    type="text"
                  ></input>
                </div>
                <div className="flex items-center px-5 md:px-0  justify-center  space-x-3 text-center">
                <input
                  required
                  className="  w-[24px] h-[24px] border-2 border-[#201F54] px-[1rem] text-black rounded-3xl"
                  type="checkbox"
