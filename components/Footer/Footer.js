...
const Footer = () => {
  return (
    ...
    <div className='max-w-6xl md:max-w-full bg-[#201F54] flex flex-col space-y-5 px-0 md:px-[5rem] py-[4rem] md:py-4 justify-center items-center space-y-6 md:space-y-0'>

    <div className='max-w-6xl md:max-w-full bg-[#201F54] flex flex-col md:flex-row  md:justify-between px-0 md:px-[5rem] py-2 md:py-[4rem] md:py-4 justify-center items-center space-y-6 md:space-y-0  gap-5 md:gap-x-32'>
           
           <div className='max-w-sm flex flex-col gap-4'>
                <h1 className='text-3xl font-bold text-white'>About us</h1>
                <p className='w-[100%] text-2xs text-white'>Tilottama Campus was established in 1996 as the first private college in Rupandehi by a team of dedicated, experienced and enterprising academicians to cater for the growing demands of parents and students in the higher education by providing quality education and guaranteeing top class graduates.</p>
           </div>



           <div className='flex flex-col justify-between items-center space-y-3 md:space-y-2 '>
                <h1 className='text-white font-bold text-3xl'>Quick Links</h1>
                    <div>
                        <ul className='flex flex-col justify-between items-center py-2 space-y-3 font-light list-disc   text-white justify-center items-start text-2xs'>
                            <li className='max-w-sm'><Link href={"/"}>About Tilottama</Link></li>
                            <li className='max-w-sm'><Link href={"/"}>Entrance Exam</Link></li>
                            <li className='max-w-sm'><Link href={"/"}>Courses</Link></li>
           ...
           <div className='flex flex-col justify-between items-center space-y-2'>
                <h1 className='text-white font-bold text-3xl pl-0 md:pl-[0.5rem]'>Contact Us</h1>
        ...
        <div className='w-[100%] h-[48px] flex flex-col justify-center items-center bg-[#FF9900] text-white font-bold text-center'>© Copyright 2023 Tilottama Campus, Rupandehi All Rights Reserved</div>
